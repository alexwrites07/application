...
function App() {
    ...
    <h3 className="mb-4 border-b pb-4 text-5xl leading-tight text-[#8AA6AA]">Blow-Fill-Seal  & Form-Fill-Seal Solutions for Pharmaceuticals</h3>
   
    <h6 className="text-1xl leading-tight text-[#8AA6AA]" color="blue">"Unleashing the Power of BFS Technology: Aseptic Filling, Sterile Containers, and Unbreakable Packaging in a Single Step!"</h6><br></br>
    <div><Button color="cyan">Explore</Button></div>
  </div><br></br>
  <div> <img
...
pharmaceutical industry</h3>
    ...
    {/* <HorizontalCard/> */}
          ...
          <br></br><br></br><div class="p-2 m-2 bg-[#8AA6AA] kp">
